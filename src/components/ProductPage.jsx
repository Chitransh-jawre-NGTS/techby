...
${productUrl}`;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      {/* <h2 className="text-3xl bg-green-200 p-2 border border-green-400 font-semibold mb-8 text-gray-800">
        {heading}
      </h2> */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-6">
        ...
        {!loading &&
          nearbyProducts.length >
            0 && (
            <>
              <h2 className="col-span-full bg-green-200 p-2 border border-green-400 text-2xl font-bold mt-4 mb-2">
                Nearby Products
              </h2>
        ...
        {/* ================= UNDER 50 KM ================= */}
        {!loading &&
          under50Products.length >
            0 && (
            <>
              <h2 className="col-span-full text-2xl font-bold mt-8 mb-2">
                Products Under
                50 KM
              </h2>
