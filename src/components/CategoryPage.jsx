...
import React from "react";
import Slider from "react-slick";
import { Smartphone, Laptop, Gamepad2, Disc, Tablet, Bike } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { FaChevronLeft, FaChevronRight } from "react-icons/fa";
...
import consoleImg from "../assets/best price/amanz-WlxBHSKW7dU-unsplash.jpg";
import cdImg from "../assets/best price/download.jpg";
import tabletImg from "../assets/images/tablet.png"; // add your image
import bikeImg from "../assets/images/bikes.webp"; // add your image
...
const CategoryPage = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-12">
      ...
      <p className="text-center text-gray-500 mb-10">
        Explore refurbished mobiles, laptops, gaming consoles, tablets and bikes.
      </p>
